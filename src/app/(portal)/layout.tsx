...
import { authenticateClient } from "@/lib/auth-guard";
import { PortalSidebar } from "@/components/portal-sidebar";
import { PortalHeader } from "@/components/portal-header";
import { PortalMobileNav } from "@/components/portal-mobile-nav";
import { PortalClientProvider } from "@/components/portal-client-provider";
import type { ClientAuthUser } from "@/stores/useClientAuthStore";
...
export default async function PortalLayout({
  ...
  const client: ClientAuthUser | null = clientRecord
    ? {
        ...clientRecord,
  ...
  return (
    <PortalClientProvider initialClient={client}>
